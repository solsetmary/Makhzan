	...
	if(mysql_num_rows($run))
	{
		...
		<script type="text/javascript">
			$(document).ready(function () {
				$("#onclick").html(\'' . '<img src="data:image/jpeg;base64,' . base64_encode($row['user_image']) . '" style="width:15px;height:20px;border-radius:10px;box-shadow: 2px 2px 1px #888888;" >  Log.Out()\');'. '
				...
				$("#service-Tweet").html("<iframe src=\"./tweet/index.php\" width=\"700px\" height=\"400px\" frameborder=\"0\" style=\"border: 0;\"></iframe>");
			});
		</script>';
	}
	ob_end_flush();
		...
		$(document).ready(function () {
            ...
            function popup() {
				...
				tour = new Tour({
					...
					onEnd: function (tour) {setTimeout(myModalAnnounceshow, 1000);},
