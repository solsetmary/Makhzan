...
namespace WebCamWindowsClient
{
    ...
    public class LogWriter
    {
        ...
        private static int maxLogAge = 1;//int.Parse(<Max Age in seconds or Config Setting>);
        private static int queueSize = 9;//int.Parse(<Max Queue Size or Config Setting);
